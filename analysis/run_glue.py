...
class StsbProcessor(DataProcessor):
    """OVERRIDE Processor for the STS-B data set (GLUE version)."""
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        """
        Examples is a list of dicts like so:
        {
            "guid": "train-0", # train id
            "label": "1",
            "text_a": "RIP Roger Rabbit ... James Bond",
            "text_b": null
        }
        """
...
def main():
    ...
    parser.add_argument('--logging_steps', type=int, default=6000,
